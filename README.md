...
`@latest` tracks npm; teams pin `@pymodel/designer-skill-mcp@0.18.0`. Plugin skill content updates separately (`/plugin update …`). MCP registry name: `io.github.PyModel/designer-skill-mcp`. Requires Node 22+.
