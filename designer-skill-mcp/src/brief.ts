...
3. Use dispatch_intent or get_command. Load only recommended references with get_reference, normally 1-4. Record why additional references are necessary. For contemporary real-screen context, find_ui_references and get_design_reference search the optional niblet.com catalogue (needs NIBLET_TOKEN; without it they return setup guidance). Catalogue results are advisory context, never a style mandate.
